...
v0.2.3 for Windows x64**. Sonic's original code is proprietary under the root
...
The v0.2.3 installer contains these independently launched tools. None is
...
| Component | Version in v0.2.3 | License | Source |
| --- | --- | --- | --- |
...
An official v0.2.3 release includes or installs:
